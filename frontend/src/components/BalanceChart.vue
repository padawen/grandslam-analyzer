...
watch(() => [props.matches, props.stake, props.roundOrder], () => {
    setTimeout(() => {
        renderMyChart();
    }, 0);
}, { deep: true });
...
<template>
    <div ref="chartContainerRef" class="glass-card p-6 animate-fade-in mb-12 relative transition-all duration-300">
         <h3 style="font-size:18px;font-weight:700;color:var(--text-primary);margin-bottom:20px;display:flex;align-items:center;justify-content:space-between;gap:12px;">
            <div style="display:flex;align-items:center;gap:10px;">
                 <svg xmlns="http://www.w3.org/2000/svg" style="width:20px;height:20px;color:var(--emerald-light);" fill="none" viewBox="0 0 24 24" stroke="currentColor">
