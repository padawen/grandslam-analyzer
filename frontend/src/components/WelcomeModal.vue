...
.modal__strategy-dot--emerald { background: var(--emerald-light); box-shadow: 0 0 8px var(--emerald); }
.modal__strategy-dot--sky { background: var(--sky); box-shadow: 0 0 8px var(--sky); }
