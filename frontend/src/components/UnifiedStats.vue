...
.dot--underdog { background: var(--emerald-light); }
.dot--favorite { background: var(--sky); }
...
.metric-row__spacer { font-size: 10px; font-weight: 800; text-transform: uppercase; color: var(--text-muted); letter-spacing: 0.1em; opacity: 0.5; white-space: nowrap; }
...
.comp-bar--underdog { background: var(--emerald-light); }
.comp-bar--favorite { background: var(--sky); }
...
.comp-pill { padding: 10px 24px; border-radius: 100px; font-size: 20px; font-weight: 800; border: 1px solid transparent; min-width: 140px; text-align: center; white-space: nowrap; }
...
@media (max-width: 900px) {
  ...
  .metric-row { grid-template-columns: 1fr; gap: 12px; padding: 16px 20px; }
  .metric-row__comparison { gap: 8px; }
  .comp-val { font-size: 18px; min-width: 50px; }
  .comp-pill { font-size: 15px; padding: 8px 14px; min-width: 0; flex: 1; }
  .roi-val { font-size: 24px; }
  .comp-bar-wrap { display: none; }
  .metric-row__spacer { flex-shrink: 0; }
}

@media (max-width: 600px) {
  .unified-stats { padding: 16px; }
  .unified-stats__header { flex-direction: column; gap: 12px; }
  .unified-stats__legend { gap: 24px; margin-top: 0; }
  .legend-item { font-size: 14px; gap: 8px; }
  .dot { width: 12px; height: 12px; }
  .unified-stats__subtitle { display: none; }
  .metric-row { padding: 14px 16px; }
  .comp-pill { font-size: 14px; padding: 7px 12px; }
  .comp-val { font-size: 16px; }
  .roi-val { font-size: 22px; }
  .comp-roi { padding: 14px 10px; }
}
</style>
